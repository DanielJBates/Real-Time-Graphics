...
#pragma region Assimp
		...
		//_pImmediateContext->VSSetShader(_pVertexShader, nullptr, 0);
		//_pImmediateContext->VSSetConstantBuffers(0, 1, &_pConstantBuffer.p); //triggers line 199 in atlomcli.h. Expression p==0
		//_pImmediateContext->PSSetShader(_pPixelShader, nullptr, 0);
		//_pImmediateContext->DrawIndexed(INDEX_COUNT, 0, 0);
#pragma endregion
