#pragma once
#include "Model.h"
class Cylinder final : public Model
{
public:
	Cylinder(DirectX::XMVECTOR& pPosition, Texture& pTexture) : Model(pPosition, pTexture) {};
	Cylinder(DirectX::XMVECTOR& pPosition, DirectX::XMVECTOR& pScale, DirectX::XMVECTOR& pRotation, Texture& pTexture) : Model(pPosition, pScale, pRotation, pTexture) {};
